...
public class Lista<T> {
    ...
    public Lista<Usuario> obtenerListaUsuarios() {
        Lista<Usuario> listaUsuarios = new Lista<>();
        Nodo<T> aux = cabeza;
        
        while (aux != null) {
            if (aux.getElemento() instanceof Usuario) {
                listaUsuarios.agregar((Usuario) aux.getElemento());
            }
            aux = aux.getSgteNodo();
        }
    ...
    public boolean agregado(T elemento) {
